...
| :--- | :---: | :---: | :---: | :---: |
| 🟢 **ผ่านการตรวจอัตโนมัติ (PASSED_VALIDATION)** | **444** | 142 | 0 | 586 |
| 🟡 **มีเงื่อนไข/ข้อควรระวัง (WARNING)** | **145** | 98 | 0 | 243 |
| ⛔ **ถูกกักกัน (BLOCKED / Formula Error)** | 75 | 0 | 0 | 75 |
| **รวมทั้งสิ้น** | **664** | **240** | **0** | **904** |

> [!IMPORTANT]
> **นโยบายการตัดขายหน้าร้าน POS**: ระบบ Dashboard จะดึงเฉพาะ Variant ที่มีสถานะ `validationStatus IN ('PASSED_VALIDATION', 'WARNING')` และอยู่ในช่วงวันที่ `startDate <= 2026-09-06 <= endDate` เท่านั้น รวมทั้งสิ้น **589 รายการ** ส่วนโปรโมชั่นที่หมดอายุ (240 รายการ) จะถูกปฏิเสธการตัดขายอัตโนมัติ
